...
package com.lox.productcatalog.services;

import com.lox.productcatalog.exceptions.ProductNotFoundException;
import com.lox.productcatalog.kafka.EventProducer;
import com.lox.productcatalog.models.Product;
import com.lox.productcatalog.models.events.ProductAddedEvent;
import com.lox.productcatalog.models.events.ProductRemovedEvent;
import com.lox.productcatalog.models.events.ProductUpdatedEvent;
import com.lox.productcatalog.models.page.ProductPage;
import com.lox.productcatalog.repositories.r2dbc.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Value("${kafka.product.events.topic}")
    ...
    public Mono<Product> createProduct(Product product) {
        ...
        return productRepository.save(product)
                .flatMap(savedProduct ->
                        Mono.fromFuture(eventProducer.sendEvent(productEventsTopic,
        ...
        return hashOps.get(HASH_KEY, key)
                ...
                .switchIfEmpty(
                        productRepository.findById(productId)
                                ...
                                .flatMap(product ->
                                        Mono.fromFuture(eventProducer.sendEvent(productEventsTopic,
                                                        ProductAddedEvent.fromProduct(product)))
                                                .then(
        ...
        return productRepository.findById(productId)
                ...
                .flatMap(existingProduct ->
                        productRepository.delete(existingProduct)
                                .then(Mono.fromFuture(eventProducer.sendEvent(productEventsTopic,
                                        ProductRemovedEvent.fromProductId(productId))))
                                // Pass the field key as an Object array to match varargs
                                .then(hashOps.remove(HASH_KEY, key))
                )
                // Convert Mono<Long> to Mono<Void> by ignoring the result
                .then()
                .doOnSuccess(
    ...
    public Mono<ProductPage> listProducts(List<String> categories, BigDecimal minPrice,
        ...
        // Asignar minPrice a 0 si es null
        if (minPrice == null) {
        ...
        if (maxPrice == null) {
            // Obtener el precio máximo existente en la base de datos
        ...
        return resolvedMaxPriceMono.flatMap(resolvedMaxPrice -> {
            // Verificar que minPrice <= resolvedMaxPrice
